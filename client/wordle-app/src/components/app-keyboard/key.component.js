...
const KeyboardKey =(props)=>{
	...
	}} className='keyboard-key' style={commonStyle } >
		{props.cellKey ==="ERASE" ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eraser" viewBox="0 0 16 16">
